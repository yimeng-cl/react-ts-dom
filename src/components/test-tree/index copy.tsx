...
const defaultData2 = generateTreeData(4);
...
const TestTree: React.FC = () => {
  ...
  return <Tree className='draggable-tree' defaultExpandedKeys={expandedKeys} blockNode onDrop={onDrop} treeData={defaultData2} />;
};
